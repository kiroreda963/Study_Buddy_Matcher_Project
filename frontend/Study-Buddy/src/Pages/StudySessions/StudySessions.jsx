...
const StudySessions = () => {
  ...
  if (loading)
    return <div className="study-sessions-container">Loading sessions...</div>;
  if (error)
    return (
      <div className="study-sessions-container">Error: {error.message}</div>
    );
          ...
          <div className="carousel-container">
            ...
            <div className="carousel-viewport">
              <div
                ...
                style={{
                  transform: `translateX(-${upcomingIndex * (33.333 + 1.5)}%)`,
                }}
              >
                {upcoming.length > 0 ? (
                  upcoming.map((session) => (
                    <SessionCard
                      ...
                      isUpcoming={true}
                      onJoin={() =>
                        joinSession({ variables: { sessionId: session.id } })
                      }
                      onLeave={() =>
